    ...
    <Container className='l-wrapper'>
      <Section>
        ...
        <Text>
          ...
          <TextRegular
            text="10개의 키워드를 조합하여 만든 여러 단어들 중 'Daylog'라는 이름을 추출했습니다."
        ...
        <Text>
          ...
          <TextRegularBoxed
            text='매 시간 뭘 하고있는지 기록하여 오늘 하루를 반성하고, 내일은 더 나은 하루를 보내고. 더 나아가 완벽한 하루를 보내기 위한 자기개발 애플리케이션 입니다.'
            className='jsAppearBtT'
          />
        </Text>
        <Text>
          ...
          <TextRegular
            text="Daylog의 맨 앞자인 'D'와 '기록'을 의미하는 깃털펜의 형태를 조합하여 심볼을 제작했고, 로고타입은 심플하고 부드러운 서체인 Open Sans를 사용했습니다."
            className='jsAppearBtT'
          />
        </Text>
        <ImageFull
      ...
      <Section>
        ...
        <Text>
          ...
          <TextRegular
            text='6개의 기본 메뉴로 구성 되어있고 하루의 일과를 관리할 수 있는 Today가 메인 페이지입니다.'
            className='jsAppearBtT'
          />
        </Text>
        <ImageFull
        ...
        <Text>
          ...
          <TextRegular
            text='혼자 하는 프로젝트지만, 플로우차트를 작성하여 여러가지 상황에 대처할 수 있도록 고민하였습니다.'
            className='jsAppearBtT'
          />
        </Text>
        <ImageFull
      ...
      <Section>
        ...
        <Text>
          ...
          <TextRegular
            text='단 3개의 정보만 입력하면 회원가입이 가능하고, 비밀번호 없이 인증코드로 로그인합니다. JWT토큰 인증방식을 사용했습니다.'
            className='jsAppearBtT'
          />
        </Text>
        <Grid pc={4} mobile={2}>
      ...
      <Section>
        ...
        <Text>
          ...
          <TextRegular
            text='타임라인 UI로 한눈에 일정을 확인할 수 있고 한번의 클릭으로 빠른 일정 등록과 수정이 가능합니다.'
            className='jsAppearBtT'
          />
        </Text>
        <Grid pc={4} mobile={2}>
      ...
      <Section>
        ...
        <Text>
          ...
          <UnorderedList
            list={[{ text: '친구의 리뷰와 일정을 피드로 확인합니다.' }, { text: '댓글과 좋아요로 서로 응원합니다.' }]}
            className='jsAppearBtT'
          />
        </Text>
        <Grid pc={4} mobile={2}>
