                ...
                <section>
                    <div className="l-wrapper">
                        <div className="text-wrap">
                            ...
                            <p className="f-normal jsAppearBtT">트렌드를 따르는 디자인 레이아웃 적용. <br />컨텐츠에 집중 할 수 있는 가벼운 배경 이미지 사용.</p>
                        </div>
                ...
                <section> 
                    <div className="l-wrapper">
                        ...
                        <div className="l-row gap60">
                            <div className="l-col l-col-6-12">
                ...
                <section>
                    <div className="l-wrapper">
                        <div className="text-wrap">
                            ...
                            <p className="f-normal jsAppearBtT"><strong>각 아티스트별 미디어 관리 플러그인</strong>기존 워드프레스 플러그인중에는 네이버TV의 영상을 임포트 하고, <br />한번에 관리할 수 있는 플러그인의 부재로, 필요에 따라 개발 시작. <br />메인페이지는 슬라이더, 상세페이지는 그리드. 클라이언트를 위한 관리자페이지 구성.</p>
                        </div>
                        ...
                        <div className="text-wrap">
                            <p className="f-normal jsAppearBtT"><strong>관리자페이지</strong>아티스트 이름을 카테고리로 지정하여 <br />유튜브 / 비메오 / 네이버TV 링크를 가져와, <br />iframe으로 보여줍니다.</p>
                        </div>
                        ...
                        <div className="text-wrap">
                            ...
                            <p className="f-normal jsAppearBtT">업로드한 영상을 클릭하면 라이트박스로 재생.<br />영상 밖의 공간으로 마우스를 옮기면 마우스가 X모양으로 바뀌고<br />클릭하면 페이드아웃.</p>
                        </div>
