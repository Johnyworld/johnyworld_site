...
import worksDevicesFanclubCoin from '../../../images/works-detail/fancoin-devices.jpg';
import worksDesignFanclubCoin1 from '../../../images/works-detail/fancoin-design-1.jpg';
import worksDesignFanclubCoin2 from '../../../images/works-detail/fancoin-design-2.jpg';
import worksDesignFanclubCoin3 from '../../../images/works-detail/fancoin-design-3.jpg';
            ...
            <>
                <div className="detail-section key-section">
                    <div className="l-wrapper-wide">
                        <img src={worksDevicesFanclubCoin} alt="deviceimg" className="device-image" />
                    </div>
                </div>
                ...
                <div className="detail-section design-image-section">
                    <div className="l-wrapper">
                        <img src={worksDesignFanclubCoin1} alt="designimg" className="design-image" />
                        <img src={worksDesignFanclubCoin2} alt="designimg" className="design-image" />
                        <img src={worksDesignFanclubCoin3} alt="designimg" className="design-image" />
                    </div>
                </div>
            </>
        )
