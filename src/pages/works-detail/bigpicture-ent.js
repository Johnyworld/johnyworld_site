...
import './bigpicture-ent.css';

import worksDevicesBigpictureEnt from '../../images/works-detail/bigpic-devices.jpg';
import worksDesignBigpictureEnt from '../../images/works-detail/bigpic-design.jpg';
            ...
            <>
                <div className="detail-section">
                    <div className="l-wrapper-wide">
                        <img src={worksDevicesBigpictureEnt} alt="deviceimg" className="device-image" />
                    </div>
                </div>
                <div className="detail-section">
                ...
                <div className="detail-section design-image-section">
                    <div className="l-wrapper">
                        <img src={worksDesignBigpictureEnt} alt="designimg" className="design-image" />
                    </div>
                </div>
            </>
        )
