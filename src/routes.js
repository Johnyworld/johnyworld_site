      ...
      <Router>
        ...
        <Switch>
          ...
          <Route
            ...
            path='/about'
            render={props => (
              <About anim_titleIn={this.anim_titleIn} anim_loadingScreenOut={this.anim_loadingScreenOut} />
            )}
          />
          ...
          <Route
            ...
            path='/blog'
            render={props => (
              <Blog anim_titleIn={this.anim_titleIn} anim_loadingScreenOut={this.anim_loadingScreenOut} />
            )}
          />
